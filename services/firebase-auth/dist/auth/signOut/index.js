...
const signOutStandard = (res, errMsg, successsMsg, auth, signOut) => () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield signOut(auth);
...
exports.goOut = signOutStandard(res_1.resp, errMessages_1.getError, successMessages_1.successMessage, config_1.auth, auth_1.signOut);
